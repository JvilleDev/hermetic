---
name: pocketbase-mcp
description: Use when working with PocketBase database operations — schema, records, backups, files, settings, logs. Provides MCP tools to manage the Hermetic PocketBase instance.
---
